...
//    get pool of matrices smaller than m+n, and store them in validmatrixmpn
    ...
    int pindicator = 1;
    for (double ppq1=-0.1; ppq1<=0.1; ppq1=ppq1+0.02){
        printf("ppq1:");
        printf("%.6f", ppq1);
        printf("\n");
        for (double ppq2=-0.1; ppq2<=0.1; ppq2=ppq2+0.02){

            for (double ppq3=-0.1; ppq3<=0.1; ppq3=ppq3+0.02){

                for (double ppq4=-0.1; ppq4<=0.1; ppq4=ppq4+0.02){

                    for (double ppq5=-0.1; ppq5<=0.1; ppq5=ppq5+0.02){

                        for (double ppq6=-0.1; ppq6<=0.1; ppq6=ppq6+0.02){
                            //matrix p+q positive
                            double tsetppq[3][3];
                            for(int i=0;i<=2;i++){
                                for(int j=0;j<=2;j++){
    ...
    int mindicator = 1;
    for (double pmq1=-0.01; pmq1<=0.01; pmq1=pmq1+0.002){
        printf("pmq1:");
        printf("%.6f", pmq1);
        printf("\n");
        for (double pmq2=-0.01; pmq2<=0.01; pmq2=pmq2+0.002){

            for (double pmq3=-0.01; pmq3<=0.01; pmq3=pmq3+0.002){

                for (double pmq4=-0.01; pmq4<=0.01; pmq4=pmq4+0.002){

                    for (double pmq5=-0.01; pmq5<=0.01; pmq5=pmq5+0.002){

                        for (double pmq6=-0.01; pmq6<=0.01; pmq6=pmq6+0.002){
                            //matrix p-q positive
                            double tsetpmq[3][3];
                            for(int i=0;i<=2;i++){
                                for(int j=0;j<=2;j++){
